<template>
  <div class="discover">
    ...
    <div class="discover-content" v-if="selectedId === 2">
      <!--1-->
      <theme :color="color">
        <themeContent :items="items"></themeContent>
        <p>aaa</p>
      </theme>
    </div>
  </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    mounted() {
		  console.log(this);
      this.$children[1].$vnode.componentOptions.propsData = Object.assign({}, {name: 'edward'})
		  console.log(this.$children[1].$vnode)
    },
    destroy() {
    }
	};
